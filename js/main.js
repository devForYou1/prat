...
function renderApp(data) {
    ...
    // Logo - Main TAAZ Logo (now an image)
    const logoContainer = document.createElement('div');
    logoContainer.className = 'logo-container';
    
    const taazLogoImage = document.createElement('img');
    taazLogoImage.src = "https://www.dropbox.com/scl/fi/jqzy0j883oi1jefzn5sfa/taaz_icon.webp?rlkey=8e0s4b5erg96tl03n8nk9mz02&raw=1";
    taazLogoImage.alt = "לוגו מרכז תע\"ץ";
    taazLogoImage.classList.add('taaz-main-logo'); // Add the class for styling
    taazLogoImage.loading = "lazy"; // Add lazy loading
    // Fallback image in case the provided URL fails
    taazLogoImage.onerror = function() { this.src = 'https://placehold.co/108x108/cccccc/000000?text=Error'; }; 

    logoContainer.appendChild(taazLogoImage); // Append the image element to its container
