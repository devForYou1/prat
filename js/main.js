...
function initializeApp(contentData) {
    ...
    const closeModal = () => {
        if (currentModal) {
            ...
            }, 200); // Match CSS transition duration for smooth closing
        }
    };
    ...
    // The direction is set in CSS for main-container-border now
    ...
    // Corrected the malformed number "15.25.7" to "15.25,0.7"
