...
function renderApp(data) {
    ...
    const mainTaazLogoSvgInnerContent = `
<defs>
    <style>
      .cls-1 {
...
`;
    ...
    // Create the SVG element using the correct namespace
    const svgElement = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    svgElement.setAttribute('id', 'Layer_1');
    svgElement.setAttribute('data-name', 'Layer 1');
    svgElement.setAttribute('viewBox', '0 0 568.89 544.35');
    svgElement.setAttribute('xmlns', 'http://www.w3.org/2000/svg');
    svgElement.setAttribute('xmlns:xlink', 'http://www.w3.org/1999/xlink');
    svgElement.classList.add('taaz-main-logo'); // Add the class for styling

    // Set the innerHTML of the SVG element
    svgElement.innerHTML = mainTaazLogoSvgInnerContent;
    ...
    data.footerLinks = [ // Overwrite existing footerLinks with the complete new set
        ...
        },
        {
            ...
            alt: "מרכז תע\"ץ",
            imgSrc: "https://www.dropbox.com/scl/fi/jqzy0j880i1jefzn5sfa/taaz_icon.webp?rlkey=8e0s4b5erg96tl03n8nk9mz02&raw=1"
        },
        {
