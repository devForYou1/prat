    ...
    const newFooterLinks = [
        {
            ...
            svgContent: `
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2C6.477 2 2 6.477 2 12c0 5.016 3.657 9.18 8.438 9.879V14.65H8.032v-2.628h2.406V10.1c0-2.388 1.452-3.696 3.582-3.696 1.025 0 1.913.076 2.169.11v2.51h-1.488c-1.17 0-1.401.557-1.401 1.376v1.815h2.802l-.454 2.628h-2.348v7.222C18.343 21.18 22 17.016 22 12c0-5.523-4.477-10-10-10z"/>
                </svg>
            `
        },
        {
            ...
            svgContent: `
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07c1.46.067 2.112.235 2.662.465.404.173.743.376 1.082.715.34.34.543.679.715 1.082.23.55.398 1.203.465 2.662.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.067 1.46-.235 2.112-.465 2.662-.173.404-.376.743-.715 1.082-.34.34-.679.543-1.082.715-.55.23-1.203.398-2.662.465-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.46-.067-2.112-.235-2.662-.465-.404-.173-.743-.376-1.082-.715-.34-.34-.543-.679-.715-1.082-.23-.55-.398-1.203-.465-2.662-.058-1.266-.07-1.646-.07-4.85s.012-3.584.07-4.85c.067-1.46.235-2.112.465-2.662.173-.404.376-.743.715-1.082.34-.34.679-.543 1.082-.715.55-.23 1.203-.398 2.662-.465C8.416 2.175 8.796 2.163 12 2.163zm0 2.163c-3.193 0-3.583.012-4.849.07-1.05.048-1.554.204-1.897.348-.25.107-.462.24-.674.452-.212.212-.345.424-.452.674-.144.343-.3.847-.348 1.897-.058 1.265-.07 1.65-.07 4.849s.012 3.583.07 4.849c.048 1.05.204 1.554.348 1.897.107.25.24.462.452.674.212.212.424.345.674.452.343.144.847.3 1.897.348 1.265.058 1.65.07 4.849.07s3.583-.012 4.849-.07c1.05-.048 1.554-.204 1.897-.348.25-.107.462-.24.674-.452.212-.212.345-.424.452-.674.144-.343.3-.847.348-1.897.058-1.265.07-1.65.07-4.849s-.012-3.583-.07-4.849c-.048-1.05-.204-1.554-.348-1.897-.107-.25-.24-.462-.452-.674-.212-.212-.424-.345-.674-.452-.343-.144-.847-.3-1.897-.348-1.265-.058-1.65-.07-4.849-.07zm0 2.917c2.114 0 3.83 1.716 3.83 3.83s-1.716 3.83-3.83 3.83-3.83-1.716-3.83-3.83 1.716-3.83 3.83-3.83zm0 2.163c-.974 0-1.767.793-1.767 1.767s.793 1.767 1.767 1.767 1.767-.793 1.767-1.767-.793-1.767-1.767-1.767zm6.058-4.117c-.484 0-.877.393-.877.877s.393.877.877.877.877-.393.877-.877-.393-.877-.877-.877z"/>
                </svg>
            `
        }
    ];
